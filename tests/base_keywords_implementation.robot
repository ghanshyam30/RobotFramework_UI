...
Test 001 Open New Browser Window And Close Previous
    ...
    Open Browser            ${base_url}             firefox    executable_path=/home/thebadcoder/TestWorkspace/RobotFramework_UI/drivers/geckodriver                          # Simulating the scenario where we have browser open and then move on to add tab in next step
